...
map.getView().fit([2801352.627368, -1416324.173626, 3959299.243470, -918564.441571], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">New Proposed Farm Blocks</h2>';
        return titleElement;
    })(),
